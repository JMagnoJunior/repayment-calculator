...
ENTRYPOINT ["java", "-Xmx512M", "-Xss512k", "-XX:MetaspaceSize=64M", "-XX:MaxMetaspaceSize=128M", "-XX:CompressedClassSpaceSize=16M" ,"-cp", "/home/builduser/myapp/app.jar:target/dependency/*", "com.magnojr.repaymentscheduleservice.RepaymentScheduleServiceApplication"]
